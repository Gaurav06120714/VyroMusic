  ...
  return (
    <div className="min-h-screen mesh-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md glass-card p-8">
        ...
        <p className="text-white/40 text-center text-sm mb-8">Free forever. No credit card required.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={isLoading} className="btn-neon w-full text-white py-3 disabled:opacity-50">
        ...
        <p className="text-center text-sm text-white/40 mt-6">
          ...
          <Link href="/login" className="text-vyro-400 hover:text-vyro-300 transition-colors font-medium">
            Log in
          </Link>
        </p>
      </div>
